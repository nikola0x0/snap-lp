...
import { TrendingUp, TrendingDown, DollarSign, Percent, AlertTriangle, RefreshCw } from 'lucide-react'
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Connect your wallet to view your DLMM positions and portfolio performance.
                </p>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-green-600">${totalFeesEarned.toFixed(2)}</div>
          </CardContent>
        </Card>
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div>
                    <CardTitle className="text-base">{position.strategyName}</CardTitle>
                    <p className="text-sm text-muted-foreground">{position.poolPair}</p>
                  </div>
